...
instance JExcelHandlers JExcelReflex where
    onload self event         = (_jexcelReflex_trigger self) event
    onbeforechange self event = (_jexcelReflex_trigger self) event
    onchange self event       = (_jexcelReflex_trigger self) event
    onafterchange self event  = (_jexcelReflex_trigger self) event
    oninsertrow self event    = (_jexcelReflex_trigger self) event
    ondeleterow self event    = (_jexcelReflex_trigger self) event
    oninsertcolumn self event = (_jexcelReflex_trigger self) event
    ondeletecolumn self event = (_jexcelReflex_trigger self) event
    onselection self event    = (_jexcelReflex_trigger self) event
    onsort self event         = (_jexcelReflex_trigger self) event
    onresize self event       = (_jexcelReflex_trigger self) event
    onmoverow self event      = (_jexcelReflex_trigger self) event
    onfocus self event        = (_jexcelReflex_trigger self) event
    onblur self event         = (_jexcelReflex_trigger self) event
