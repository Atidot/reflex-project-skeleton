...
newJExcel element
    ...
    --withHandler js_config "oninsertrow"    (oninsertrow handlers)
    --withHandler js_config "ondeleterow"    (ondeleterow handlers)
    --withHandler js_config "oninsertcolumn" (oninsertcolumn handlers)
    --withHandler js_config "ondeletecolumn" (ondeletecolumn handlers)
    --withHandler js_config "onselection"    (onselection handlers)
    --withHandler js_config "onsort"         (onsort handlers)
    --withHandler js_config "onresize"       (onresize handlers)
    --withHandler js_config "onmoverow"      (onmoverow handlers)
    --withHandler js_config "onfocus"        (onfocus handlers)
    --withHandler js_config "onblur"         (onblur handlers)
